...
아래 페르소나는 ohmyti를 시험하기 위해 제작한 가상 인물이며, 실존하는 인물·회사와 관련이 없습니다. 네 명 모두 같은 채용 과제인 주문·재고 API([SPEC.md](https://github.com/wanted-hack-inchyangv/ohmyti/blob/main/samples/order-api/SPEC.md))를 제출했고, 수준에 따라 서로 다른 결함이 설계되어 있습니다. 백도현은 실행 기준을 한서진과 똑같이 만점 받지만, 제출 테스트가 결함을 잡지 못해 테스트 실효성에서 점수가 갈립니다.
...
| [**백도현**](https://github.com/wanted-hack-inchyangv/ohmyti/blob/main/samples/personas/dohyun/persona.md) (`dohyun`)<br><sub>5년차 미들, SI 백엔드</sub> | [`dohyun-order-api`](https://github.com/wanted-hack-inchyangv/dohyun-order-api)<br><sub>과제 제출물 · Express, 단일 파일</sub><br>[`dohyun-board-api`](https://github.com/wanted-hack-inchyangv/dohyun-board-api)<br><sub>포트폴리오 · 게시판 REST API</sub><br>[`dohyun-report-batch`](https://github.com/wanted-hack-inchyangv/dohyun-report-batch)<br><sub>포트폴리오 · 매출 보고서 배치</sub> | R-01 ~ R-11 전부 통과, 테스트 실효성 실패<br><sub>제출 테스트가 주입한 결함을 잡지 못함 · 낮은 설계 품질</sub> | [75~90/100](https://ohmyti.vercel.app/evaluations/58451401-116a-4aea-b13f-e20de92a869f)<br><sub>워크벤치에서 열기</sub> |
